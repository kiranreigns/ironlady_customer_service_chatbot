class ChatManager:
    """
    Manager for handling chat sessions and message storage.
    """    
    def __init__(self):
    ...
    def create_chat(self, user_id, chat_id, system_prompt):
        ...
        self.chats[user_id][chat_id] = {"system_prompt": system_prompt, "messages": []}
    ...
    def get_conversation(self, user_id, chat_id):
        ...
        if chat := self.get_chat(user_id, chat_id):
            return [{"role": "system", "content": chat["system_prompt"]}] + chat[
                "messages"
            ]
        return []
